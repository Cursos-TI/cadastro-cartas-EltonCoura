...
int main(){
    ...
    printf("\n######### Resultado ###########\n");
    printf("\nCarta 1 = 1 - Vence e Carta 2 = 0 - Vence\n");
    printf("\nPopulação: Carta 1 = %d e Carta 2 = %d\n", população_c1 > população_c2, população_c1 < população_c2);
    printf("Área: Carta 1 = %d e Carta 2 = %d\n", area_c1 > area_c2, area_c1 < area_c2);
    printf("PIB: Carta 1 = %d e Carta 2 = %d\n", pib_c1 > pib_c2, pib_c1 < pib_c2);
    printf("Número de pontos turísticos: Carta 1 = %d e Carta 2 = %d\n", n_pontos_tur_c1 > n_pontos_tur_c2, n_pontos_tur_c1 < n_pontos_tur_c2);
    printf("PIB per capita: Carta 1 = %d e Carta 2 = %d\n", pib_per_capita_c1 > pib_per_capita_c2, pib_per_capita_c1 < pib_per_capita_c2);
    printf("Densidade populacional: Carta 1 = %d e Carta 2 = %d\n", densidade_populacional_c1 > densidade_populacional_c2, densidade_populacional_c1 < densidade_populacional_c2);
    printf("Super Poder: Carta 1 = %d e Carta 2 = %d\n", super_poder_c1 > super_poder_c2, super_poder_c1 < super_poder_c2);
    printf("\n######### -------- ###########\n");
